...
import { Mail, Key, User, Phone, MapPin } from 'lucide-react';
...
const SignUpPage: React.FC = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      ...
      // After successful sign-up, sign them in
      ...
      <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center bg-muted/30 px-4 py-8">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Join DevOpsWizard to manage your DevOps LLM Bot instances
            </CardDescription>
          </CardHeader>
          <CardContent>
                      ...
                      <FormItem>
                        ...
                        <FormControl>
                          <div className="relative">
                            ...
                            <Input 
                              placeholder="aymenkoched@yopmail.com" 
                              className="pl-10" 
                              {...field} 
                              disabled={isSubmitting}
                            />
